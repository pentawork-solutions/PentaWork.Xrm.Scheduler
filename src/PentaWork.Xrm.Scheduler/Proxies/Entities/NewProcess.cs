...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	[EntityLogicalName("newprocess")]
	public sealed class NewProcess : Entity
	{	
		public static readonly int? EntityTypeCode = 950;
		...
		public NewProcess() : base("newprocess") { }
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'lk_newprocess_workflowlogs'
        /// </summary>
		[RelationshipSchemaName("lk_newprocess_workflowlogs")]
		public IEnumerable<ProcessLog> LkNewprocessWorkflowlogs
		{
			get { return GetRelatedEntities<ProcessLog>("lk_newprocess_workflowlogs", null); }
			set { SetRelatedEntities("lk_newprocess_workflowlogs", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'NewProcess_ProcessSessions'
        /// </summary>
		[RelationshipSchemaName("NewProcess_ProcessSessions")]
		public IEnumerable<ProcessSession> NewProcessProcessSessions
		{
			get { return GetRelatedEntities<ProcessSession>("NewProcess_ProcessSessions", null); }
			set { SetRelatedEntities("NewProcess_ProcessSessions", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'NewProcess_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("NewProcess_SyncErrors")]
		public IEnumerable<SyncError> NewProcessSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("NewProcess_SyncErrors", null); }
			set { SetRelatedEntities("NewProcess_SyncErrors", null, value); }
		}
		#endregion
		...
		public static class Schemas 
		{
			...
			public const string LkNewprocessWorkflowlogs = "lk_newprocess_workflowlogs";

			/// <summary>1:N NewProcess_ProcessSessions</summary>
			public const string NewProcessProcessSessions = "NewProcess_ProcessSessions";

			/// <summary>1:N NewProcess_SyncErrors</summary>
			public const string NewProcessSyncErrors = "NewProcess_SyncErrors";
