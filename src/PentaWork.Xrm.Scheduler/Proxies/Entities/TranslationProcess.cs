...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	[EntityLogicalName("translationprocess")]
	public sealed class TranslationProcess : Entity
	{	
		public static readonly int? EntityTypeCode = 951;
		public new const string LogicalName = "translationprocess";
		public const string PrimaryIdAttribute = "businessprocessflowinstanceid";
		public const string PrimaryNameAttribute = "name";
	
		public TranslationProcess() : base("translationprocess") { }
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'lk_translationprocess_workflowlogs'
        /// </summary>
		[RelationshipSchemaName("lk_translationprocess_workflowlogs")]
		public IEnumerable<ProcessLog> LkTranslationprocessWorkflowlogs
		{
			get { return GetRelatedEntities<ProcessLog>("lk_translationprocess_workflowlogs", null); }
			set { SetRelatedEntities("lk_translationprocess_workflowlogs", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'TranslationProcess_ProcessSessions'
        /// </summary>
		[RelationshipSchemaName("TranslationProcess_ProcessSessions")]
		public IEnumerable<ProcessSession> TranslationProcessProcessSessions
		{
			get { return GetRelatedEntities<ProcessSession>("TranslationProcess_ProcessSessions", null); }
			set { SetRelatedEntities("TranslationProcess_ProcessSessions", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'TranslationProcess_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("TranslationProcess_SyncErrors")]
		public IEnumerable<SyncError> TranslationProcessSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("TranslationProcess_SyncErrors", null); }
			set { SetRelatedEntities("TranslationProcess_SyncErrors", null, value); }
		}
		#endregion
		...
		public static class Properties 
		{
			...
			public const string TranslationProcessInstanceId = "businessprocessflowinstanceid";
		...
		public static class Schemas 
		{
			...
			public const string LkTranslationprocessWorkflowlogs = "lk_translationprocess_workflowlogs";

			/// <summary>1:N TranslationProcess_ProcessSessions</summary>
			public const string TranslationProcessProcessSessions = "TranslationProcess_ProcessSessions";

			/// <summary>1:N TranslationProcess_SyncErrors</summary>
			public const string TranslationProcessSyncErrors = "TranslationProcess_SyncErrors";
