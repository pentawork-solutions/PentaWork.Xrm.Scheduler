	...
	{	
		...
		{	
			...
			set 
			{
				...
				if(moneyValue.Value == EstValue) return;
		...
		{	
			...
			set 
			{
				...
				if(doubleValue == EstValuedeprecated) return;
				SetAttributeValue("estimatedvalue", doubleValue);  
			}
		}
		...
		{	
			...
			set 
			{
				...
				if(moneyValue.Value == AnnualRevenue) return;
