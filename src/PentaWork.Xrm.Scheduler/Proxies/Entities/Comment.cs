...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	{	
		public static readonly int? EntityTypeCode = 8005;
		...
		public Comment() : base("postcomment") { }
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("postcommentid", value); }
		}
        ...
        /// postidname
        /// </summary>
		[DisplayName("postidname")]
		[AttributeLogicalName("postidname")]
		public string Postidname
		{	
			get { return GetAttributeValue<string>("postidname"); }
			set
			{ 
				if(value == Postidname) return;
				SetAttributeValue("postidname", value);
			}
		}	
