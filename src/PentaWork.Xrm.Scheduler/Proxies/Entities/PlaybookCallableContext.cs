...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	[EntityLogicalName("msdyn_callablecontext")]
	public sealed class PlaybookCallableContext : Entity
	{	
		public static readonly int? EntityTypeCode = 10076;
		public new const string LogicalName = "msdyn_callablecontext";
		...
		public PlaybookCallableContext() : base("msdyn_callablecontext") { }
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("msdyn_callablecontextid", value); }
		}
		...
		public string Name
		{	
			get { return GetAttributeValue<string>("msdyn_EntityLogicalName"); }
			set
			{ 
		...
		[AttributeLogicalName("msdyn_EntityOTC")]
		public eEntity? RecordType
		{	
			get 
			{ 
				var optionSetValue = GetAttributeValue<OptionSetValue>("msdyn_EntityOTC");
				if (optionSetValue != null) return (eEntity)optionSetValue.Value;
				else return null;
			}
			set 
			{ 
				...
				SetAttributeValue("msdyn_EntityOTC", optionSetValue); 
			}
		}
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_AsyncOperations")]
		public IEnumerable<SystemJob> MsdynCallablecontextAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("msdyn_callablecontext_AsyncOperations", null); }
			set { SetRelatedEntities("msdyn_callablecontext_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> MsdynCallablecontextBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("msdyn_callablecontext_BulkDeleteFailures", null); }
			set { SetRelatedEntities("msdyn_callablecontext_BulkDeleteFailures", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_DuplicateBaseRecord'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_DuplicateBaseRecord")]
		public IEnumerable<DuplicateRecord> MsdynCallablecontextDuplicateBaseRecord
		{
			get { return GetRelatedEntities<DuplicateRecord>("msdyn_callablecontext_DuplicateBaseRecord", null); }
			set { SetRelatedEntities("msdyn_callablecontext_DuplicateBaseRecord", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_DuplicateMatchingRecord'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_DuplicateMatchingRecord")]
		public IEnumerable<DuplicateRecord> MsdynCallablecontextDuplicateMatchingRecord
		{
			get { return GetRelatedEntities<DuplicateRecord>("msdyn_callablecontext_DuplicateMatchingRecord", null); }
			set { SetRelatedEntities("msdyn_callablecontext_DuplicateMatchingRecord", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_MailboxTrackingFolders'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_MailboxTrackingFolders")]
		public IEnumerable<MailboxAutoTrackingFolder> MsdynCallablecontextMailboxTrackingFolders
		{
			get { return GetRelatedEntities<MailboxAutoTrackingFolder>("msdyn_callablecontext_MailboxTrackingFolders", null); }
			set { SetRelatedEntities("msdyn_callablecontext_MailboxTrackingFolders", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_PrincipalObjectAttributeAccesses'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_PrincipalObjectAttributeAccesses")]
		public IEnumerable<FieldSharing> MsdynCallablecontextPrincipalObjectAttributeAccesses
		{
			get { return GetRelatedEntities<FieldSharing>("msdyn_callablecontext_PrincipalObjectAttributeAccesses", null); }
			set { SetRelatedEntities("msdyn_callablecontext_PrincipalObjectAttributeAccesses", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_ProcessSession'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_ProcessSession")]
		public IEnumerable<ProcessSession> MsdynCallablecontextProcessSession
		{
			get { return GetRelatedEntities<ProcessSession>("msdyn_callablecontext_ProcessSession", null); }
			set { SetRelatedEntities("msdyn_callablecontext_ProcessSession", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'msdyn_callablecontext_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_SyncErrors")]
		public IEnumerable<SyncError> MsdynCallablecontextSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("msdyn_callablecontext_SyncErrors", null); }
			set { SetRelatedEntities("msdyn_callablecontext_SyncErrors", null, value); }
		}
		/// <summary>
        /// N:N Get entities for 'PlaybookTemplate'
        /// </summary>
		[RelationshipSchemaName("msdyn_callablecontext_msdyn_playbooktemplate")]
		public IEnumerable<PlaybookTemplate> MsdynCallablecontextMsdynPlaybooktemplate
		{
			get { return GetRelatedEntities<PlaybookTemplate>("msdyn_callablecontext_msdyn_playbooktemplate", null); }
		...
		public static class Properties 
		{
			...
			/// <summary>msdyn_callablecontextid</summary>
			public const string PlaybookCallingRecordTypeId = "msdyn_callablecontextid";

			/// <summary>msdyn_EntityLogicalName</summary>
			public const string Name = "msdyn_EntityLogicalName";

			/// <summary>msdyn_EntityOTC</summary>
			public const string RecordType = "msdyn_EntityOTC";
		...
		public static class Schemas 
		{
			...
			public const string MsdynCallablecontextBulkDeleteFailures = "msdyn_callablecontext_BulkDeleteFailures";

			/// <summary>1:N msdyn_callablecontext_DuplicateBaseRecord</summary>
			public const string MsdynCallablecontextDuplicateBaseRecord = "msdyn_callablecontext_DuplicateBaseRecord";

			/// <summary>1:N msdyn_callablecontext_DuplicateMatchingRecord</summary>
			public const string MsdynCallablecontextDuplicateMatchingRecord = "msdyn_callablecontext_DuplicateMatchingRecord";

			/// <summary>1:N msdyn_callablecontext_MailboxTrackingFolders</summary>
			public const string MsdynCallablecontextMailboxTrackingFolders = "msdyn_callablecontext_MailboxTrackingFolders";

			/// <summary>1:N msdyn_callablecontext_PrincipalObjectAttributeAccesses</summary>
			public const string MsdynCallablecontextPrincipalObjectAttributeAccesses = "msdyn_callablecontext_PrincipalObjectAttributeAccesses";

			/// <summary>1:N msdyn_callablecontext_ProcessSession</summary>
			public const string MsdynCallablecontextProcessSession = "msdyn_callablecontext_ProcessSession";

			/// <summary>1:N msdyn_callablecontext_SyncErrors</summary>
			public const string MsdynCallablecontextSyncErrors = "msdyn_callablecontext_SyncErrors";
