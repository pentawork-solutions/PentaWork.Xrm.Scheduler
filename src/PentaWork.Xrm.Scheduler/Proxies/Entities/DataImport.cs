...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	{	
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("importid", value); }
		}
		...
		{	
			get 
			{ 
				var optionSetValue = GetAttributeValue<OptionSetValue>("modecode");
			...
			{ 
				...
				SetAttributeValue("modecode", optionSetValue); 
			}
		}
		...
		{	
			...
			set
			{ 
				if(value == SendNotification) return;
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'Import_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("Import_AsyncOperations")]
		public IEnumerable<SystemJob> ImportAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("Import_AsyncOperations", null); }
			set { SetRelatedEntities("Import_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'Import_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("Import_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> ImportBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("Import_BulkDeleteFailures", null); }
			set { SetRelatedEntities("Import_BulkDeleteFailures", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'Import_ImportFile'
        /// </summary>
		[RelationshipSchemaName("Import_ImportFile")]
		public IEnumerable<ImportSourceFile> ImportImportFile
		{
			get { return GetRelatedEntities<ImportSourceFile>("Import_ImportFile", null); }
			set { SetRelatedEntities("Import_ImportFile", null, value); }
		}
		#endregion
		...
		public static class Schemas 
		{
			...
			public const string ImportBulkDeleteFailures = "Import_BulkDeleteFailures";

			/// <summary>1:N Import_ImportFile</summary>
			public const string ImportImportFile = "Import_ImportFile";
