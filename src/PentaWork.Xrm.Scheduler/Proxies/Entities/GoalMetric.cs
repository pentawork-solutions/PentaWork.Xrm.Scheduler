...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	public sealed class GoalMetric : Entity
	{	
		public static readonly int? EntityTypeCode = 9603;
		public new const string LogicalName = "metric";
		public const string PrimaryIdAttribute = "metricid";
		public const string PrimaryNameAttribute = "name";
	
		public GoalMetric() : base("metric") { }
		...
		public bool? TrackStretchTarget
		{	
			get { return GetAttributeValue<bool?>("isstretchtracked"); }
			set
			{ 
				if(value == TrackStretchTarget) return;
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("metricid", value); }
		}
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'metric_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("metric_AsyncOperations")]
		public IEnumerable<SystemJob> MetricAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("metric_AsyncOperations", null); }
			set { SetRelatedEntities("metric_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'metric_goal'
        /// </summary>
		[RelationshipSchemaName("metric_goal")]
		public IEnumerable<Goal> MetricGoal
		{
			get { return GetRelatedEntities<Goal>("metric_goal", null); }
			set { SetRelatedEntities("metric_goal", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'metric_ProcessSessions'
        /// </summary>
		[RelationshipSchemaName("metric_ProcessSessions")]
		public IEnumerable<ProcessSession> MetricProcessSessions
		{
			get { return GetRelatedEntities<ProcessSession>("metric_ProcessSessions", null); }
			set { SetRelatedEntities("metric_ProcessSessions", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'metric_rollupfield'
        /// </summary>
		[RelationshipSchemaName("metric_rollupfield")]
		public IEnumerable<RollupField> MetricRollupfield
		{
			get { return GetRelatedEntities<RollupField>("metric_rollupfield", null); }
			set { SetRelatedEntities("metric_rollupfield", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'Metric_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("Metric_SyncErrors")]
		public IEnumerable<SyncError> MetricSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("Metric_SyncErrors", null); }
			set { SetRelatedEntities("Metric_SyncErrors", null, value); }
		}
		#endregion
		...
		public static class Properties 
		{
			...
			/// <summary>isstretchtracked</summary>
			public const string TrackStretchTarget = "isstretchtracked";

			/// <summary>metricid</summary>
			public const string GoalMetricId = "metricid";
		...
		public static class Schemas 
		{
			...
			public const string MetricGoal = "metric_goal";

			/// <summary>1:N metric_ProcessSessions</summary>
			public const string MetricProcessSessions = "metric_ProcessSessions";

			/// <summary>1:N metric_rollupfield</summary>
			public const string MetricRollupfield = "metric_rollupfield";

			/// <summary>1:N Metric_SyncErrors</summary>
			public const string MetricSyncErrors = "Metric_SyncErrors";
