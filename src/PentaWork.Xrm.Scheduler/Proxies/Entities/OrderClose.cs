...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	public sealed class OrderClose : Entity
	{	
		public static readonly int? EntityTypeCode = 4209;
		public new const string LogicalName = "orderclose";
		public const string PrimaryIdAttribute = "activityid";
		public const string PrimaryNameAttribute = "subject";
	
		public OrderClose() : base("orderclose") { }
        ...
        /// salesorderidtype
        /// </summary>
		[DisplayName("salesorderidtype")]
		[AttributeLogicalName("salesorderidtype")]
		public string Salesorderidtype
		{	
			get { return GetAttributeValue<string>("salesorderidtype"); }
			set
			{ 
				if(value == Salesorderidtype) return;
				SetAttributeValue("salesorderidtype", value);
			}
		}	
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'CampaignResponse_OrderCloses'
        /// </summary>
		[RelationshipSchemaName("CampaignResponse_OrderCloses")]
		public IEnumerable<CampaignResponse> CampaignResponseOrderCloses
		{
			get { return GetRelatedEntities<CampaignResponse>("CampaignResponse_OrderCloses", null); }
			set { SetRelatedEntities("CampaignResponse_OrderCloses", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'orderclose_activity_parties'
        /// </summary>
		[RelationshipSchemaName("orderclose_activity_parties")]
		public IEnumerable<ActivityParty> OrdercloseActivityParties
		{
			get { return GetRelatedEntities<ActivityParty>("orderclose_activity_parties", null); }
			set { SetRelatedEntities("orderclose_activity_parties", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'OrderClose_Annotation'
        /// </summary>
		[RelationshipSchemaName("OrderClose_Annotation")]
		public IEnumerable<Note> OrderCloseAnnotation
		{
			get { return GetRelatedEntities<Note>("OrderClose_Annotation", null); }
			set { SetRelatedEntities("OrderClose_Annotation", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'OrderClose_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("OrderClose_AsyncOperations")]
		public IEnumerable<SystemJob> OrderCloseAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("OrderClose_AsyncOperations", null); }
			set { SetRelatedEntities("OrderClose_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'OrderClose_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("OrderClose_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> OrderCloseBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("OrderClose_BulkDeleteFailures", null); }
			set { SetRelatedEntities("OrderClose_BulkDeleteFailures", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'orderclose_MailboxTrackingFolders'
        /// </summary>
		[RelationshipSchemaName("orderclose_MailboxTrackingFolders")]
		public IEnumerable<MailboxAutoTrackingFolder> OrdercloseMailboxTrackingFolders
		{
			get { return GetRelatedEntities<MailboxAutoTrackingFolder>("orderclose_MailboxTrackingFolders", null); }
			set { SetRelatedEntities("orderclose_MailboxTrackingFolders", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'orderclose_PrincipalObjectAttributeAccesses'
        /// </summary>
		[RelationshipSchemaName("orderclose_PrincipalObjectAttributeAccesses")]
		public IEnumerable<FieldSharing> OrderclosePrincipalObjectAttributeAccesses
		{
			get { return GetRelatedEntities<FieldSharing>("orderclose_PrincipalObjectAttributeAccesses", null); }
			set { SetRelatedEntities("orderclose_PrincipalObjectAttributeAccesses", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'OrderClose_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("OrderClose_SyncErrors")]
		public IEnumerable<SyncError> OrderCloseSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("OrderClose_SyncErrors", null); }
			set { SetRelatedEntities("OrderClose_SyncErrors", null, value); }
		}
		#endregion
		...
		public static class Properties 
		{
			...
			public const string OrderCloseId = "activityid";
			...
			/// <summary>salesorderidtype</summary>
			public const string Salesorderidtype = "salesorderidtype";
		...
		public static class Schemas 
		{
			...
			public const string CampaignResponseOrderCloses = "CampaignResponse_OrderCloses";

			/// <summary>1:N orderclose_activity_parties</summary>
			public const string OrdercloseActivityParties = "orderclose_activity_parties";

			/// <summary>1:N OrderClose_Annotation</summary>
			public const string OrderCloseAnnotation = "OrderClose_Annotation";
			...
			public const string OrderCloseBulkDeleteFailures = "OrderClose_BulkDeleteFailures";

			/// <summary>1:N orderclose_MailboxTrackingFolders</summary>
			public const string OrdercloseMailboxTrackingFolders = "orderclose_MailboxTrackingFolders";

			/// <summary>1:N orderclose_PrincipalObjectAttributeAccesses</summary>
			public const string OrderclosePrincipalObjectAttributeAccesses = "orderclose_PrincipalObjectAttributeAccesses";

			/// <summary>1:N OrderClose_SyncErrors</summary>
			public const string OrderCloseSyncErrors = "OrderClose_SyncErrors";
