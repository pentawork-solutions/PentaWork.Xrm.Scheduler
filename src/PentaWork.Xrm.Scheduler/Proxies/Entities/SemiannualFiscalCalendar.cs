...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	public sealed class SemiannualFiscalCalendar : Entity
	{	
		public static readonly int? EntityTypeCode = 2001;
		public new const string LogicalName = "semiannualfiscalcalendar";
		public const string PrimaryIdAttribute = "userfiscalcalendarid";
		public const string PrimaryNameAttribute = "";
	
		public SemiannualFiscalCalendar() : base("semiannualfiscalcalendar") { }
		...
		{	
			get { return GetAttributeValue<Money>("firsthalf")?.Value; }
			set 
			{
				...
				if(moneyValue.Value == Firsthalf) return;
				SetAttributeValue("firsthalf", moneyValue);  
			}
		}
		...
		{	
			get { return GetAttributeValue<Money>("secondhalf")?.Value; }
			set 
			{
				Money moneyValue = null;
				if(value != null) 
				...
				if(moneyValue.Value == Secondhalf) return;
				SetAttributeValue("secondhalf", moneyValue);  
			}
		}
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'SemiAnnualFiscalCalendar_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("SemiAnnualFiscalCalendar_AsyncOperations")]
		public IEnumerable<SystemJob> SemiAnnualFiscalCalendarAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("SemiAnnualFiscalCalendar_AsyncOperations", null); }
			set { SetRelatedEntities("SemiAnnualFiscalCalendar_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'SemiAnnualFiscalCalendar_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("SemiAnnualFiscalCalendar_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> SemiAnnualFiscalCalendarBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("SemiAnnualFiscalCalendar_BulkDeleteFailures", null); }
			set { SetRelatedEntities("SemiAnnualFiscalCalendar_BulkDeleteFailures", null, value); }
		}
		#endregion
		...
		{
			/// <summary>1:N SemiAnnualFiscalCalendar_AsyncOperations</summary>
			public const string SemiAnnualFiscalCalendarAsyncOperations = "SemiAnnualFiscalCalendar_AsyncOperations";

			/// <summary>1:N SemiAnnualFiscalCalendar_BulkDeleteFailures</summary>
			public const string SemiAnnualFiscalCalendarBulkDeleteFailures = "SemiAnnualFiscalCalendar_BulkDeleteFailures";
