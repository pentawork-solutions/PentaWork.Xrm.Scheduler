...
{
	[DebuggerDisplay("{ConnectionReferenceDisplayName}")] 	
	[EntityLogicalName("connectionreference")]
	public sealed class ConnectionReference : Entity
	{	
		public static readonly int? EntityTypeCode = 10030;
		public new const string LogicalName = "connectionreference";
		...
		public ConnectionReference() : base("connectionreference") { }
		...
		{	
			get { return GetAttributeValue<string>("connectionreferencedisplayname"); }
			set
			{ 
				if(value == ConnectionReferenceDisplayName) return;
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("connectionreferenceid", value); }
		}
		...
		{	
			get { return GetAttributeValue<string>("connectionreferencelogicalname"); }
			set
			{ 
				if(value == ConnectionReferenceLogicalName) return;
		...
		{	
			get { return GetAttributeValue<string>("connectorid"); }
			set
			{ 
		...
		{	
			get { return GetAttributeValue<EntityReference>("customconnectorid"); }
			set
			{ 
				if(value == CustomConnectorId) return;
        ...
        /// </summary>
		[DisplayName("customconnectoridname")]
		[AttributeLogicalName("customconnectoridname")]
		public string Customconnectoridname
		{	
			get { return GetAttributeValue<string>("customconnectoridname"); }
			set
			{ 
				if(value == Customconnectoridname) return;
				SetAttributeValue("customconnectoridname", value);
			}
		}	
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'connectionreference_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("connectionreference_AsyncOperations")]
		public IEnumerable<SystemJob> ConnectionreferenceAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("connectionreference_AsyncOperations", null); }
			set { SetRelatedEntities("connectionreference_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'connectionreference_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("connectionreference_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> ConnectionreferenceBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("connectionreference_BulkDeleteFailures", null); }
			set { SetRelatedEntities("connectionreference_BulkDeleteFailures", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'connectionreference_MailboxTrackingFolders'
        /// </summary>
		[RelationshipSchemaName("connectionreference_MailboxTrackingFolders")]
		public IEnumerable<MailboxAutoTrackingFolder> ConnectionreferenceMailboxTrackingFolders
		{
			get { return GetRelatedEntities<MailboxAutoTrackingFolder>("connectionreference_MailboxTrackingFolders", null); }
			set { SetRelatedEntities("connectionreference_MailboxTrackingFolders", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'connectionreference_PrincipalObjectAttributeAccesses'
        /// </summary>
		[RelationshipSchemaName("connectionreference_PrincipalObjectAttributeAccesses")]
		public IEnumerable<FieldSharing> ConnectionreferencePrincipalObjectAttributeAccesses
		{
			get { return GetRelatedEntities<FieldSharing>("connectionreference_PrincipalObjectAttributeAccesses", null); }
			set { SetRelatedEntities("connectionreference_PrincipalObjectAttributeAccesses", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'connectionreference_ProcessSession'
        /// </summary>
		[RelationshipSchemaName("connectionreference_ProcessSession")]
		public IEnumerable<ProcessSession> ConnectionreferenceProcessSession
		{
			get { return GetRelatedEntities<ProcessSession>("connectionreference_ProcessSession", null); }
			set { SetRelatedEntities("connectionreference_ProcessSession", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'connectionreference_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("connectionreference_SyncErrors")]
		public IEnumerable<SyncError> ConnectionreferenceSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("connectionreference_SyncErrors", null); }
			set { SetRelatedEntities("connectionreference_SyncErrors", null, value); }
		}
		#endregion
		...
		public static class Properties 
		{
			...
			/// <summary>connectionreferencedisplayname</summary>
			...
			/// <summary>connectionreferencelogicalname</summary>
			...
			/// <summary>customconnectorid</summary>
			public const string CustomConnectorId = "customconnectorid";

			/// <summary>customconnectoridname</summary>
