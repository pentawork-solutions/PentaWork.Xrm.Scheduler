...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	public sealed class CaseResolution : Entity
	{	
		public static readonly int? EntityTypeCode = 4206;
		public new const string LogicalName = "incidentresolution";
		public const string PrimaryIdAttribute = "activityid";
		public const string PrimaryNameAttribute = "subject";
	
		public CaseResolution() : base("incidentresolution") { }
        ...
        /// incidentidtype
        /// </summary>
		[DisplayName("incidentidtype")]
		[AttributeLogicalName("incidentidtype")]
		public string Incidentidtype
		{	
			get { return GetAttributeValue<string>("incidentidtype"); }
			set
			{ 
				if(value == Incidentidtype) return;
				SetAttributeValue("incidentidtype", value);
			}
		}	
		...
		public eIncidentresolutionIncidentStatuscode? ResolutionType
		{	
			get 
			{ 
				var optionSetValue = GetAttributeValue<OptionSetValue>("resolutiontypecode");
				if (optionSetValue != null) return (eIncidentresolutionIncidentStatuscode)optionSetValue.Value;
				else return null;
			}
			set 
			{ 
				if(value == ResolutionType) return;

				OptionSetValue optionSetValue = null;
				if(value != null) optionSetValue = new OptionSetValue((int)value);
				SetAttributeValue("resolutiontypecode", optionSetValue); 
			}
		}
		...
		{	
			get { return GetAttributeValue<int?>("totaltimespent"); }
			set
			{ 
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'CampaignResponse_IncidentResolutions'
        /// </summary>
		[RelationshipSchemaName("CampaignResponse_IncidentResolutions")]
		public IEnumerable<CampaignResponse> CampaignResponseIncidentResolutions
		{
			get { return GetRelatedEntities<CampaignResponse>("CampaignResponse_IncidentResolutions", null); }
			set { SetRelatedEntities("CampaignResponse_IncidentResolutions", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'incidentresolution_activity_parties'
        /// </summary>
		[RelationshipSchemaName("incidentresolution_activity_parties")]
		public IEnumerable<ActivityParty> IncidentresolutionActivityParties
		{
			get { return GetRelatedEntities<ActivityParty>("incidentresolution_activity_parties", null); }
			set { SetRelatedEntities("incidentresolution_activity_parties", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'IncidentResolution_Annotation'
        /// </summary>
		[RelationshipSchemaName("IncidentResolution_Annotation")]
		public IEnumerable<Note> IncidentResolutionAnnotation
		{
			get { return GetRelatedEntities<Note>("IncidentResolution_Annotation", null); }
			set { SetRelatedEntities("IncidentResolution_Annotation", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'IncidentResolution_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("IncidentResolution_AsyncOperations")]
		public IEnumerable<SystemJob> IncidentResolutionAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("IncidentResolution_AsyncOperations", null); }
			set { SetRelatedEntities("IncidentResolution_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'IncidentResolution_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("IncidentResolution_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> IncidentResolutionBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("IncidentResolution_BulkDeleteFailures", null); }
			set { SetRelatedEntities("IncidentResolution_BulkDeleteFailures", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'incidentresolution_MailboxTrackingFolders'
        /// </summary>
		[RelationshipSchemaName("incidentresolution_MailboxTrackingFolders")]
		public IEnumerable<MailboxAutoTrackingFolder> IncidentresolutionMailboxTrackingFolders
		{
			get { return GetRelatedEntities<MailboxAutoTrackingFolder>("incidentresolution_MailboxTrackingFolders", null); }
			set { SetRelatedEntities("incidentresolution_MailboxTrackingFolders", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'incidentresolution_PrincipalObjectAttributeAccesses'
        /// </summary>
		[RelationshipSchemaName("incidentresolution_PrincipalObjectAttributeAccesses")]
		public IEnumerable<FieldSharing> IncidentresolutionPrincipalObjectAttributeAccesses
		{
			get { return GetRelatedEntities<FieldSharing>("incidentresolution_PrincipalObjectAttributeAccesses", null); }
			set { SetRelatedEntities("incidentresolution_PrincipalObjectAttributeAccesses", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'IncidentResolution_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("IncidentResolution_SyncErrors")]
		public IEnumerable<SyncError> IncidentResolutionSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("IncidentResolution_SyncErrors", null); }
			set { SetRelatedEntities("IncidentResolution_SyncErrors", null, value); }
		}
		#endregion
		...
		public enum eIncidentresolutionIncidentStatuscode
		{	
		...
		public static class Properties 
		{
			...
			public const string CaseResolutionId = "activityid";
			...
			public const string Remarks = "description";
			...
			/// <summary>resolutiontypecode</summary>
			public const string ResolutionType = "resolutiontypecode";
			...
			/// <summary>timespent</summary>
			public const string BillableTime = "timespent";
			...
			/// <summary>totaltimespent</summary>
			public const string TotalTime = "totaltimespent";
		...
		public static class Schemas 
		{
			...
			public const string CampaignResponseIncidentResolutions = "CampaignResponse_IncidentResolutions";

			/// <summary>1:N incidentresolution_activity_parties</summary>
			public const string IncidentresolutionActivityParties = "incidentresolution_activity_parties";

			/// <summary>1:N IncidentResolution_Annotation</summary>
			public const string IncidentResolutionAnnotation = "IncidentResolution_Annotation";
			...
			public const string IncidentResolutionBulkDeleteFailures = "IncidentResolution_BulkDeleteFailures";

			/// <summary>1:N incidentresolution_MailboxTrackingFolders</summary>
			public const string IncidentresolutionMailboxTrackingFolders = "incidentresolution_MailboxTrackingFolders";

			/// <summary>1:N incidentresolution_PrincipalObjectAttributeAccesses</summary>
			public const string IncidentresolutionPrincipalObjectAttributeAccesses = "incidentresolution_PrincipalObjectAttributeAccesses";

			/// <summary>1:N IncidentResolution_SyncErrors</summary>
			public const string IncidentResolutionSyncErrors = "IncidentResolution_SyncErrors";
