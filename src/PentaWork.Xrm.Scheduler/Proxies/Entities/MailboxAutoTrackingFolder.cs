...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	[EntityLogicalName("mailboxtrackingfolder")]
	public sealed class MailboxAutoTrackingFolder : Entity
	{	
		public static readonly int? EntityTypeCode = 9608;
		public new const string LogicalName = "mailboxtrackingfolder";
		public const string PrimaryIdAttribute = "mailboxtrackingfolderid";
		public const string PrimaryNameAttribute = "";
	
		public MailboxAutoTrackingFolder() : base("mailboxtrackingfolder") { }
		...
		{	
			get { return GetAttributeValue<string>("exchangefolderid"); }
			set
			{ 
				if(value == ExchangeFolderId) return;
				SetAttributeValue("exchangefolderid", value);
			}
		}	
		...
		{	
			get { return GetAttributeValue<string>("exchangefoldername"); }
			set
			{ 
				if(value == ExchangeFolderName) return;
				SetAttributeValue("exchangefoldername", value);
			}
		}	
		...
		{	
			get { return GetAttributeValue<int?>("folderonboardingstatus"); }
			set
			{ 
				if(value == FolderOnBoardingStatus) return;
				SetAttributeValue("folderonboardingstatus", value);
			}
		}	
		...
		{	
			get { return GetAttributeValue<EntityReference>("mailboxid"); }
			set
			{ 
				if(value == MailboxId) return;
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("mailboxtrackingfolderid", value); }
		}
		...
		{	
			...
			set
			{ 
				if(value == RegardingObjectName) return;
		...
		public static class Properties 
		{
			...
			/// <summary>mailboxtrackingfolderid</summary>
