...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	public sealed class DuplicateDetectionRule : Entity
	{	
		public static readonly int? EntityTypeCode = 4414;
		public new const string LogicalName = "duplicaterule";
		public const string PrimaryIdAttribute = "duplicateruleid";
		public const string PrimaryNameAttribute = "name";
	
		public DuplicateDetectionRule() : base("duplicaterule") { }
		...
		public string BaseRecordTypeMatchCodeTable
		{	
			get { return GetAttributeValue<string>("baseentitymatchcodetable"); }
			set
			{ 
				if(value == BaseRecordTypeMatchCodeTable) return;
				SetAttributeValue("baseentitymatchcodetable", value);
			}
		}	
		...
		{	
			...
			set
			{ 
				if(value == BaseRecordType) return;
		...
		public eBaseRecordType? BaseRecordType2
		{	
			get 
			{ 
				var optionSetValue = GetAttributeValue<OptionSetValue>("baseentitytypecode");
				if (optionSetValue != null) return (eBaseRecordType)optionSetValue.Value;
				else return null;
			}
			set 
			{ 
				if(value == BaseRecordType2) return;

				OptionSetValue optionSetValue = null;
				if(value != null) optionSetValue = new OptionSetValue((int)value);
				SetAttributeValue("baseentitytypecode", optionSetValue); 
			}
		}
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("duplicateruleid", value); }
		}
		...
		{	
			...
			set
			{ 
				if(value == ExcludeInactiveRecords) return;
		...
		public string MatchingRecordTypeMatchCodeTable
		{	
			get { return GetAttributeValue<string>("matchingentitymatchcodetable"); }
			set
			{ 
				if(value == MatchingRecordTypeMatchCodeTable) return;
				SetAttributeValue("matchingentitymatchcodetable", value);
			}
		}	
		...
		public string MatchingRecordType
		{	
			get { return GetAttributeValue<string>("matchingentityname"); }
			set
			{ 
				if(value == MatchingRecordType) return;
		...
		public eMatchingRecordType? MatchingRecordType2
		{	
			get 
			{ 
				var optionSetValue = GetAttributeValue<OptionSetValue>("matchingentitytypecode");
				if (optionSetValue != null) return (eMatchingRecordType)optionSetValue.Value;
				else return null;
			}
			set 
			{ 
				if(value == MatchingRecordType2) return;

				OptionSetValue optionSetValue = null;
				if(value != null) optionSetValue = new OptionSetValue((int)value);
				SetAttributeValue("matchingentitytypecode", optionSetValue); 
			}
		}
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'DuplicateRule_Annotation'
        /// </summary>
		[RelationshipSchemaName("DuplicateRule_Annotation")]
		public IEnumerable<Note> DuplicateRuleAnnotation
		{
			get { return GetRelatedEntities<Note>("DuplicateRule_Annotation", null); }
			set { SetRelatedEntities("DuplicateRule_Annotation", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'DuplicateRule_DuplicateBaseRecord'
        /// </summary>
		[RelationshipSchemaName("DuplicateRule_DuplicateBaseRecord")]
		public IEnumerable<DuplicateRecord> DuplicateRuleDuplicateBaseRecord
		{
			get { return GetRelatedEntities<DuplicateRecord>("DuplicateRule_DuplicateBaseRecord", null); }
			set { SetRelatedEntities("DuplicateRule_DuplicateBaseRecord", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'DuplicateRule_DuplicateRuleConditions'
        /// </summary>
		...
		public IEnumerable<DuplicateRuleCondition> DuplicateRuleDuplicateRuleConditions
		{
			...
			set { SetRelatedEntities("DuplicateRule_DuplicateRuleConditions", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'DuplicateRule_SyncErrors'
        /// </summary>
		[RelationshipSchemaName("DuplicateRule_SyncErrors")]
		public IEnumerable<SyncError> DuplicateRuleSyncErrors
		{
			get { return GetRelatedEntities<SyncError>("DuplicateRule_SyncErrors", null); }
			set { SetRelatedEntities("DuplicateRule_SyncErrors", null, value); }
		}
		#endregion
		...
		public enum eMatchingRecordType
		{	
		...
		{
			/// <summary>baseentitymatchcodetable</summary>
			public const string BaseRecordTypeMatchCodeTable = "baseentitymatchcodetable";

			/// <summary>baseentityname</summary>
			public const string BaseRecordType = "baseentityname";

			/// <summary>baseentitytypecode</summary>
			public const string BaseRecordType2 = "baseentitytypecode";
			...
			public const string DuplicateDetectionRuleId = "duplicateruleid";

			/// <summary>excludeinactiverecords</summary>
			public const string ExcludeInactiveRecords = "excludeinactiverecords";

			/// <summary>iscasesensitive</summary>
			public const string CaseSensitive = "iscasesensitive";

			/// <summary>matchingentitymatchcodetable</summary>
			public const string MatchingRecordTypeMatchCodeTable = "matchingentitymatchcodetable";

			/// <summary>matchingentityname</summary>
			public const string MatchingRecordType = "matchingentityname";

			/// <summary>matchingentitytypecode</summary>
			public const string MatchingRecordType2 = "matchingentitytypecode";
