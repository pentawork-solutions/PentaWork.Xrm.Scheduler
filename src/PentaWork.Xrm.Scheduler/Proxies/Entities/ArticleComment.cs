...
namespace PentaWork.Xrm.Scheduler.Proxies.Entities
{
	...
	public sealed class ArticleComment : Entity
	{	
		public static readonly int? EntityTypeCode = 1082;
		public new const string LogicalName = "kbarticlecomment";
		public const string PrimaryIdAttribute = "kbarticlecommentid";
		public const string PrimaryNameAttribute = "title";
	
		public ArticleComment() : base("kbarticlecomment") { }
		...
		{
			get => base.Id;
			set { base.Id = value; SetAttributeValue("kbarticlecommentid", value); }
		}
		...
		public EntityReference KBArticle
		{	
			get { return GetAttributeValue<EntityReference>("kbarticleid"); }
			set
			{ 
				if(value == KBArticle) return;
		...
		#region Relations
			/// <summary>
        /// 1:N Get entities for 'KbArticleComment_AsyncOperations'
        /// </summary>
		[RelationshipSchemaName("KbArticleComment_AsyncOperations")]
		public IEnumerable<SystemJob> KbArticleCommentAsyncOperations
		{
			get { return GetRelatedEntities<SystemJob>("KbArticleComment_AsyncOperations", null); }
			set { SetRelatedEntities("KbArticleComment_AsyncOperations", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'KbArticleComment_BulkDeleteFailures'
        /// </summary>
		[RelationshipSchemaName("KbArticleComment_BulkDeleteFailures")]
		public IEnumerable<BulkDeleteFailure> KbArticleCommentBulkDeleteFailures
		{
			get { return GetRelatedEntities<BulkDeleteFailure>("KbArticleComment_BulkDeleteFailures", null); }
			set { SetRelatedEntities("KbArticleComment_BulkDeleteFailures", null, value); }
		}
		/// <summary>
        /// 1:N Get entities for 'KbArticleComment_ProcessSessions'
        /// </summary>
		[RelationshipSchemaName("KbArticleComment_ProcessSessions")]
		public IEnumerable<ProcessSession> KbArticleCommentProcessSessions
		{
			get { return GetRelatedEntities<ProcessSession>("KbArticleComment_ProcessSessions", null); }
			set { SetRelatedEntities("KbArticleComment_ProcessSessions", null, value); }
		}
		#endregion
		...
		public static class Properties 
		{
			...
			/// <summary>kbarticlecommentid</summary>
			public const string ArticleCommentId = "kbarticlecommentid";
		...
		public static class Schemas 
		{
			...
			public const string KbArticleCommentBulkDeleteFailures = "KbArticleComment_BulkDeleteFailures";

			/// <summary>1:N KbArticleComment_ProcessSessions</summary>
			public const string KbArticleCommentProcessSessions = "KbArticleComment_ProcessSessions";
